...
const (
	...
	ImageModeBasic ImageMode = "basic"
	ImageModeAll   ImageMode = "all"
)

// AllValues returns all ImageMode values.
func (ImageMode) AllValues() []ImageMode {
	return []ImageMode{
		ImageModeNone,
		ImageModeBasic,
		ImageModeAll,
...
// MarshalText implements encoding.TextMarshaler.
func (s ImageMode) MarshalText() ([]byte, error) {
	switch s {
	case ImageModeNone:
		return []byte(s), nil
	case ImageModeBasic:
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *ImageMode) UnmarshalText(data []byte) error {
	switch ImageMode(data) {
	case ImageModeNone:
		*s = ImageModeNone
		return nil
	case ImageModeBasic:
...
// NewOptImageMode returns new OptImageMode with value set to v.
func NewOptImageMode(v ImageMode) OptImageMode {
	return OptImageMode{
		Value: v,
		Set:   true,
	}
...
// OptImageMode is optional ImageMode.
type OptImageMode struct {
	Value ImageMode
	Set   bool
}

// IsSet returns true if OptImageMode was set.
func (o OptImageMode) IsSet() bool { return o.Set }

// Reset unsets value.
func (o *OptImageMode) Reset() {
	var v ImageMode
	o.Value = v
	o.Set = false
}
...
// SetTo sets value to v.
func (o *OptImageMode) SetTo(v ImageMode) {
	o.Set = true
	o.Value = v
}

// Get returns value and boolean that denotes whether value was set.
func (o OptImageMode) Get() (v ImageMode, ok bool) {
	if !o.Set {
		return v, false
	}
	return o.Value, true
...
// Or returns value if set, or given parameter if does not.
func (o OptImageMode) Or(d ImageMode) ImageMode {
	if v, ok := o.Get(); ok {
		return v
	}
	return d
