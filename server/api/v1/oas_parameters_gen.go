...
func decodeGetRepoMediaParams(args [1]string, argsEscaped bool, r *http.Request) (params GetRepoMediaParams, _ error) {
	...
	// Set default value for query: images.
	{
		val := ImageMode("none")
		params.Images.SetTo(val)
	}
	// Decode query: images.
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotImagesVal ImageMode
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotImagesVal = ImageMode(c)
					return nil
				}(); err != nil {
					return err
				}
				params.Images.SetTo(paramsDotImagesVal)
				return nil
			}); err != nil {
				return err
			}
			if err := func() error {
				if value, ok := params.Images.Get(); ok {
					if err := func() error {
